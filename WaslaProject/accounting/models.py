...
class User(AbstractUser):
    ...
    phone_number = models.CharField(
        ...
        max_length=17,
        blank=True,
        help_text=_('Enter phone number in international format')
    )
    ...
    account_type = models.CharField(
        ...
        default='personal',
        help_text=_('Select whether this is a personal or company account')
    )
    ...
    company_name = models.CharField(
        ...
        max_length=200, 
        blank=True,
        help_text=_('Required for company accounts')
    )
    ...
    updated_at = models.DateTimeField(
        auto_now=True,
        help_text=_('Date when the account was last updated')
    )
    ...
    email_notifications = models.BooleanField(
        ...
        default=True,
        help_text=_('Receive email notifications about hackathons')
    )
